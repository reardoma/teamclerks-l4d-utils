...
public _NPF_OnPluginEnabled()
{
    ...
    HookConVarChange(FindConVar(TANK_PROP_FADE_CVAR), _NPF_TankPropFade_CvarChange);
...
public _NPF_OnPluginDisabled()
{
    ...
    UnhookConVarChange(FindConVar(TANK_PROP_FADE_CVAR), _NPF_TankPropFade_CvarChange);
 ...
 * @noreturn
 */
public _NPF_TankPropFade_CvarChange(Handle:convar, const String:oldValue[], const String:newValue[])
{
    SetConVarBool(FindConVar(TANK_PROP_FADE_CVAR), false);
    DebugPrintToAllEx("Reset sv_tankpropfade to 0");
}

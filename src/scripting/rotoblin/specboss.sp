...
public _SB_OnPluginEnabled()
{
    ...
    HookConVarChange(FindConVar(TANK_HEALTH_VS_MODIFIER_CVAR), _SB_Tank_CvarChange);
}
...
public _SB_OnPluginDisabled()
{
    ...
    UnhookConVarChange(FindConVar(TANK_HEALTH_VS_MODIFIER_CVAR), _SB_Tank_CvarChange);
}
